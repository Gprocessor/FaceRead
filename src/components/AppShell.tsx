...
import {
  LayoutDashboard, Users, Building2, ScanFace, CalendarCheck, History,
  FileBarChart, Settings, ShieldCheck, LogOut, Menu, X,
} from 'lucide-react';
...
export function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      {/* Sidebar */}
      <aside className={cn(
        'fixed lg:static inset-y-0 left-0 z-40 w-64 bg-sidebar text-sidebar-foreground flex flex-col border-r border-sidebar-border transform transition-transform lg:translate-x-0',
        ...
        <div className="flex items-center gap-2 px-5 py-5">
          ...
          <span className="text-display font-bold">FaceAttend</span>
        </div>
        ...
        <div className="border-t border-sidebar-border p-4">
          ...
          <button onClick={handleLogout} className="mt-3 w-full flex items-center gap-2 rounded-md px-2 py-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors">
