...
async def list_employees(request: Request):
    ...
    # Determine face-enrollment status in a SINGLE query (no head=True — not
    # supported by the deployed postgrest-py). Fetch active face profiles and
    # build a set of employee_ids, then mark each employee.
