...
export interface CheckInOutResponse { success: boolean; employee_id: string; attendance_log_id: string; attendance_session_id: string; check_type: string; status: string; verification_status: string; face_match_score: number; liveness_score: number; message: string; duplicate: boolean; }
